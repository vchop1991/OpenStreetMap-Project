...
OSMFILE_sample = "/Users/vinutachopra/Desktop/bengaluru_india.osm"
regex = re.compile(r'\b\S+\.?', re.IGNORECASE)

expected = ["Bengaluru", "Road", "Avenue", "Phase"] #expected names in the dataset

mapping = {"bengaluru": "Bengaluru",
           "Bangalore": "Bengaluru",
           "bangalore": "Bengaluru",
